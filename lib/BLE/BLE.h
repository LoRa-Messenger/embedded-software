...
extern BLECharacteristic *recCharSendID, *recCharRecID, *recCharMesID, *recCharTime, *recCharLat, *recCharLong, *recCharText;
extern BLECharacteristic *senCharSendID, *senCharRecID, *senCharMesID, *senCharText;

extern bool isReceivingBLE;
